...
window.SyntaxHighlighter.brushes.Asm = function () {
  ...
  this.regexList = [
    ...
    { regex: window.SyntaxHighlighter.regexLib.doubleQuotedString, css: 'asmstring' },
    { regex: window.SyntaxHighlighter.regexLib.singleQuotedString, css: 'asmstring' },
...
window.SyntaxHighlighter.brushes.Asm.prototype = new window.SyntaxHighlighter.Highlighter();
window.SyntaxHighlighter.brushes.Asm.aliases = ['asm', 'x86'];
...
/*
playback timings (ms):
  captures_list: 81.077
  exclusion.robots: 0.137
  exclusion.robots.policy: 0.125
  RedisCDXSource: 15.848
  esindex: 0.009
  LoadShardBlock: 42.539 (3)
  PetaboxLoader3.datanode: 64.632 (4)
  CDXLines.iter: 19.698 (3)
  load_resource: 100.212
  PetaboxLoader3.resolve: 40.363
*/